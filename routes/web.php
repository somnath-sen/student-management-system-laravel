...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::get('/admin/results',
        [ResultPublishController::class, 'index']
    )->name('admin.results.index');

    Route::post('/admin/results/{subject}/publish',
        [ResultPublishController::class, 'publish']
    )->name('admin.results.publish');

    Route::post('/admin/results/{subject}/unpublish',
        [ResultPublishController::class, 'unpublish']
...
Route::middleware(['auth', 'role:teacher'])->group(function () {
    ...
    // ✅ Attendance form page (GET)
    Route::get('/teacher/attendance/create',
    ...
    Route::get('/teacher/marks/create',
        [\App\Http\Controllers\Teacher\MarkController::class, 'create']
    )->name('teacher.marks.create');

    Route::post('/teacher/marks',
        [\App\Http\Controllers\Teacher\MarkController::class, 'store']
    )->name('teacher.marks.store');

    // Show marks list for edit
    Route::get('/teacher/marks',
        [\App\Http\Controllers\Teacher\MarkController::class, 'index']
    )->name('teacher.marks.index');

    // Edit marks by subject
    Route::get('/teacher/marks/{subject}',
        [\App\Http\Controllers\Teacher\MarkController::class, 'edit']
    )->name('teacher.marks.edit');

    // Update marks
    Route::put('/teacher/marks/{subject}',
        [\App\Http\Controllers\Teacher\MarkController::class, 'update']
