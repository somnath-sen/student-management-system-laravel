...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // 4. Teachers
        $teachers = $this->seedTeachers($subjects);

        // 5. Students & History
        $this->seedStudents($courses, $subjects, $teachers);
    ...
    /**
     * Seed teachers and assign them to subjects.
     */
    private function seedTeachers(\Illuminate\Support\Collection $subjects): \Illuminate\Support\Collection
    {
        $teachers = collect();
        for ($i = 1; $i <= 10; $i++) {
            $user = User::create([
    ...
    /**
     * Seed students with attendance, marks, fees, and gamification data.
     */
    ...
    /**
     * Seed attendance, marks, fees, and gamification for a single student.
     */
