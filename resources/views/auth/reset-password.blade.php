<x-guest-layout>
    ...
    <div class="reset-card p-2 rounded-2xl animate-enter {{ $errors->any() ? 'animate-shake' : '' }}">
        ...
        <div class="text-center mb-6">
            <div class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-indigo-100 text-indigo-600 mb-4 shadow-sm">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11.536 19.464a2.25 2.25 0 01-.56.452l-3.376 1.688a1.5 1.5 0 01-1.992-1.306v-.63c0-.528-.352-1.002-.871-1.096A6.002 6.002 0 019 13.5a6 6 0 119-2.5z"></path></svg>
            </div>
            <h2 class="text-2xl font-bold text-gray-900">{{ __('Reset Password') }}</h2>
            <p class="text-sm text-gray-500 mt-2">{{ __('Create a new, secure password.') }}</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.store') }}" class="space-y-4">
            ...
            <div class="text-center mt-4">
                <a href="{{ route('login') }}" class="text-sm text-indigo-600 hover:text-indigo-800 font-medium hover:underline transition-colors">
                    Back to Login
                </a>
            </div>
        </form>
