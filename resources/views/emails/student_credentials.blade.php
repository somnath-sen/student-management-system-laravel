...
<head>
    ...
    <title>EdFlow Student Account Approved</title>
                    ...
                    <tr>
                        <td style="background:linear-gradient(135deg, #0f172a 0%, #1e293b 60%, #1e3a8a 100%);padding:44px 36px 36px;text-align:center;border-bottom:4px solid #f97316;">
                            ...
                            <p style="margin:10px 0 0;color:#94a3b8;font-size:15px;font-weight:500;">
                                Student Management &amp; Smart Campus Portal
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:36px 32px 28px;">
                            ...
                            <p style="color:#475569;font-size:15px;line-height:1.7;margin:0 0 28px;">
                                Congratulations! Your Student application for the 
                                <strong style="color:#0f172a;">{{ $registration->course?->name ?? ($registration->course ?: 'Academic Program') }}</strong> 
                                has been officially approved. Your EdFlow Student account is ready for immediate access.
                            </p>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="padding:10px 0;border-bottom:1px solid #edf2f7;">
                                            ...
                                            <span style="font-size:15px;color:#0f172a;font-weight:700;">{{ $user->email }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding:10px 0;border-bottom:1px solid #edf2f7;">
                                            ...
                                            <span style="font-size:15px;color:#0f172a;font-weight:700;font-family:monospace;">{{ $dob ?: ($registration->date_of_birth ? \Carbon\Carbon::parse($registration->date_of_birth)->format('d-m-Y') : 'N/A') }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="padding:10px 0;border-bottom:1px solid #edf2f7;">
                                            ...
                                            <span style="font-size:14px;color:#334155;font-weight:700;font-family:monospace;">{{ $registration->application_no }}</span>
                                        </td>
                                    </tr>
                                    @endif
                                    ...
                                    <tr>
                                        <td style="padding:10px 0;border-bottom:1px solid #edf2f7;">
                                            <span style="font-size:12px;color:#64748b;font-weight:700;display:block;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:2px;">Roll Number</span>
                                            <span style="font-size:14px;color:#334155;font-weight:700;font-family:monospace;">{{ $registration->roll }}</span>
                                        </td>
                                    </tr>
                                    @endif
                                    <tr>
                                        <td style="padding:10px 0;">
                                            <span style="font-size:12px;color:#64748b;font-weight:700;display:block;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:2px;">Course</span>
                                            <span style="font-size:14px;color:#334155;font-weight:700;">{{ $registration->course?->name ?? ($registration->course ?: 'Assigned Course') }}</span>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div style="background:#eff6ff;border-left:4px solid #2563eb;border-radius:10px;padding:16px 18px;margin:0 0 24px;">
                                <p style="margin:0;font-size:13px;color:#1e40af;line-height:1.6;">
                                    💡 <strong>Password Format Notice:</strong> Your initial password is your date of birth in <strong>DDMMYYYY</strong> format (leading zeros included). For example, if your DOB is <code>03-03-2003</code>, your initial password is <code>03032003</code>.
                                </p>
                            </div>
                            ...
                            <div style="background:#fffbeb;border-left:4px solid #f59e0b;border-radius:10px;padding:16px 18px;margin:0 0 28px;">
                                <p style="margin:0;font-size:13px;color:#92400e;line-height:1.6;">
                                    ⚠️ <strong>Security Recommendation:</strong> For your account security, please log in and change your password to a strong personal password as soon as possible.
                                </p>
                            </div>

                            <!-- Action CTA Button -->
                            <div style="text-align:center;margin:0 0 32px;">
                                <a href="{{ route('login') }}" style="display:inline-block;background:linear-gradient(135deg, #0f172a 0%, #1e3a8a 100%);color:#ffffff;text-decoration:none;font-weight:800;font-size:16px;padding:16px 44px;border-radius:12px;box-shadow:0 10px 25px -5px rgba(15,23,42,0.4);letter-spacing:-0.2px;border:1px solid #1e293b;">
                                    🚀 Login to EdFlow Portal
                                </a>
                            </div>

                            <p style="color:#64748b;font-size:13px;line-height:1.6;margin:0;text-align:center;">
                                Having trouble logging in? Contact your institution administration for assistance.
                            </p>
                        </td>
                    </tr>
